...
const Summary = () => {
  ...
  return (
    <div>
      ...
      <div>
        <p
          className={`c-heading-28 u-spacing-40 ${styles.SummaryHeader}`}
      ...
      {finalProducts.map((finalProduct, finalProductsIndex) => {
        return (
          <div className="u-spacing-40" key={finalProduct.productID}>
            ...
            <div
              className={`c-feature ${styles.FeaturesContainer}`}
              key={finalProductsIndex}
            >
              <div
                className={`c-feature__options c-feature__options--summary ${styles.FeaturesList}`}
              >
                ...
                {finalProduct.usp_1 ? (
                  <div className="c-feature__description">
                    <div className="c-feature__description-text-wrapper c-feature__description-text-wrapper--summary">
                      <span
                        className={`c-feature__description-text c-feature__description-text--summary ${styles.FeatureText}`}
              ...
              <div className="c-feature__wrapper">
                <div className="c-summary__img-wrapper">
                  <div
                    className={`o-aspect  o-aspect--smaller u-spacing-flush u-text-center ${styles.SummaryImageContainer}`}
                  >
                    <div
                      className={`c-summary__img ${styles.SummaryImage}`}
                      style={{
                  ...
                  <div className="c-summary__price-wrapper">
                    <p
                      className={`c-summary__price u-type-bold ${styles.PriceText}`}
                    >{`${helpers.formatter.format(finalProduct.MSRP)}`}</p>
                  </div>
