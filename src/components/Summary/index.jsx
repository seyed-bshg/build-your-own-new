            ...
            <ol className="o-list-unstyled">
              ...
              <li>
                  ...
                  <fieldset className="form-row form-row-fullwidth">
                    <legend className="sr-only">How was the experience of building your dishwasher?</legend>
                    <h2 className="a-heading">How was the experience of building your dishwasher? <sup className="sub">*</sup> </h2>
              ...
              <li>
                  ...
                  <fieldset className="form-row form-row-fullwidth">
                  <legend className="sr-only">Were you able to build the right dishwasher for you?</legend>
                    <h2 className="a-heading">Were you able to build the right dishwasher for you? <sup className="sub">*</sup> </h2>
              ...
              <li>
                  ...
                  <fieldset className="form-row form-row-fullwidth">
                    ...
                    <h2 className="a-heading">How likely are you to purchase the dishwasher(s) you built? <sup className="sub">*</sup> </h2>
              ...
              <li>
                  ...
                  <fieldset className="form-row form-row-fullwidth">
                    <h2 className="a-heading">What are your Top 5 categories when purchasing a dishwasher? <sup className="sub">*</sup> </h2>
                    <div className="m-forminput m-forminput-radio had-focus">
                      <fieldset>
                ...
                <div className="c-feature__wrapper">
                  <div className="c-summary__img-wrapper">
                    ...
                    <div className="c-summary__price-wrapper">
                      <h2 className="c-summary__price u-type-bold">{`${helpers.formatter.format(finalProduct.MSRP)}`}</h2>
                    </div>
                  </div>
